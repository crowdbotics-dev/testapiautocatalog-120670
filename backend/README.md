...
## Project Structure
    ...
    ├── testapiautocatalog_120670  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_120670`
...
2. Clone this repo and `cd testapiautocatalog_120670`
